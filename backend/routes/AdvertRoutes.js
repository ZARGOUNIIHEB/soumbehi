...
const { addAdvert, getAdvertById, updateAdvert, deleteAdvert, getAllAdverts, getAdvertByUserAdvert } = require('../controllers/AdvertControllers');
...
//http://localhost:5000/advert/getAdvertByUserAdvert/:userAdvert
